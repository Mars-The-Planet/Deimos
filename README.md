...
## Setup
You can either use my [IntelliJ templates](https://github.com/Mars-The-Planet/Multiloader-Templates-with-Deimos) which generate a new MultiLoader project with Deimos preconfigured, or follow these instructions to set it up manually:
